 ...
 */
@Component("flags-auto")
public class AutomatedPostingFlagTask implements ITask {
    ...
    private static final Logger log = Logger.getLogger(AutomatedPostingFlagTask.class);

    private static final String FLAG_AUTO_POSTING = "automated-posting-flag";
     ...
     */
    @Autowired
    public AutomatedPostingFlagTask(IUtils utils, IDataSource dao, IMongoDataSource nosql) {
        this.utils = utils;
        this.dao = dao;
        this.nosql = nosql;
    }
