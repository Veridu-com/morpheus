 ...
 * All rights reserved.
 */
package com.veridu.skynet.models.email;
...
public class EmailMLPModel extends GenericModel implements Serializable {

    private static final long serialVersionUID = -6978125240459416714L;

    private MultilayerPerceptron mlpClassifier;

    public EmailMLPModel() {
    }
     ...
     */
    public EmailMLPModel(MultilayerPerceptron mlpClassifier) {
